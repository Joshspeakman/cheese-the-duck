...
EVENT_COMMENTS: Dict[str, List[ContextComment]] = {
    ...
    "found_shiny": [
        ...
        ContextComment("*clutching shiny* Mine. If you even THINK about taking it—"),
...
CONVERSATION_RESPONSES: Dict[str, List[ContextComment]] = {
    ...
    "playful": [
        ...
        ContextComment("Every time I think I'm too tired, you do something funny. Curse you."),
        ...
        ContextComment("I came in cynical. You're making me... enjoy things. Witchcraft."),
