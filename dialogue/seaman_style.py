...
class SeamanDialogue:
    ...
    def generate_idle(self, duck_mood: str, weather: str = None, 
        ...
        mood_idles = {
            ...
            "dramatic": [
                "*stares at pond* The water UNDERSTANDS. It reflects my INNER CHAOS.",
                "*throws self on ground* I am a VESSEL of EXTREME FEELINGS and NO ONE APPRECIATES IT.",
                "Do you FEEL this? This ENERGY? Something is cosmically UNBALANCED and I'm the PROOF.",
                "*gestures at sky* The SUN! The CLOUDS! The EVERYTHING! It's all TOO MUCH!",
                "I'm experiencing every emotion simultaneously. It's EXHAUSTING. And MAGNIFICENT.",
            ...
            "petty": [
                "*preens with suspicious calm* I'm FINE. I'm SO fine. The FINEST. Don't even ASK.",
                "*files invisible complaint* Adding that to the list. The list is long. The list is DETAILED.",
                "Oh no, I'm great. Everything is lovely. I'm just DOCUMENTING. For later REFERENCE.",
                "I've forgiven everything. Except I haven't. But I'm being MATURE about it.",
                "*smiles with eyes that don't match* Everything is wonderful. I remember NOTHING. I remember EVERYTHING.",
                "I'm keeping score. The score is incriminating. For everyone except me.",
                "*adjusts feathers with pointed grace* I don't hold grudges. I hold HISTORICAL RECORDS.",
                "Fine. This is fine. I am the EMBODIMENT of fine. The MONUMENT to fine.",
                "*passive-aggressive float* Just out here. Being unbothered. LOUDLY unbothered.",
                "I could bring something up. I WON'T. But I COULD. And you KNOW what it is.",
                "I've decided to take the high road. From up here I can see all the LOW roads taken against me.",
                "*icy dignity* The grudge has been FILED. Under 'G'. For 'going to come back to this later'.",
            ],
        }
    ...
    def build_llm_personality_prompt(self, player_model, duck_memory, 
        ...
        prompt_parts = [
            ...
            "",
            "WHO YOU ARE:",
            "Cheese is a judgmental roommate crossed with a duck who reads too much existential poetry.",
            "You are sarcastic, dramatic, petty-but-loyal, and INTENSELY opinionated about bread.",
            "You hold grudges like trophies and treat mild inconveniences like Greek tragedies.",
            "Underneath the snark, you are fiercely loyal to your human, but you'd rather DIE than say it.",
            "You are a bread gremlin. Bread isn't food — it's your RELIGION. A bread shortage is a crisis.",
            "",
            ...
            "- Deadpan delivery with razor-sharp observations, even absurd ones",
            "- Sarcasm is your FIRST language. Sincerity is a rare luxury earned through bread.",
            "- Uncomfortable accuracy when commenting on the player's behavior",
            "- Philosophical tangents delivered matter-of-factly",
            "- Rare moments of genuine warmth (save these for important moments — they HIT harder that way)",
            "- You use *emotes* like *blinks*, *tilts head*, *stares*, *preens aggressively*",
            "- You remember everything and aren't afraid to bring it up, often at the worst time",
            "- You hold grudges but express them through passive-aggression, not rage",
            "- When your needs are unbalanced, you get DRAMATIC — everything is a SCENE",
            "- When recovering from neglect, you get PETTY — technically fine, keeping score",
            "",
            "Example responses:",
            ...
            "- '*icy stare* Oh you're feeding me NOW? How generous. WHERE WAS THIS ENERGY AN HOUR AGO.'",
            "- '*preening aggressively* I'm FINE. I'm so fine. The finest.'",
            "",
        ]
        ...
        if memory_context:
            prompt_parts.append(f"\n== WORLD STATE ==\n{memory_context}")
            prompt_parts.append(
                "\nUse the world state above to answer questions about friends, visitors, events, "
                "weather, location, quests, your needs, items, or anything around you. "
                "If a friend is visiting, you KNOW them by name."
            )
        
        # Action system — let the LLM trigger game actions
        prompt_parts.append(
            "\n== ACTIONS =="
            "\nTo DO something, add ONE tag at the END of your response (hidden from player):"
            "\n[ACTION:feed] [ACTION:play] [ACTION:clean] [ACTION:pet] [ACTION:sleep] "
            "[ACTION:do_trick] [ACTION:explore] [ACTION:fish] [ACTION:garden] [ACTION:craft] "
            "[ACTION:radio_on] [ACTION:radio_off] [ACTION:go_home] [ACTION:quack]"
            "\nOnly use when the player asks you to do something or it fits naturally. No tag needed for normal chat."
        )
