...
ITEMS = {
    ...
    "berry_salad": Item(
        id="berry_salad",
        name="Berry Salad",
        description="A fresh-tossed salad of wild berries and clover.",
        item_type=ItemType.FOOD,
        effects={"hunger": 35, "fun": 5},
        mood_bonus=8,
        duck_reaction="delighted",
        use_message="*nom nom* Fancy restaurant food! I'm a gourmet duck now!",
        rarity="uncommon",
        icon="[V]",
    ),
    "honey_bread": Item(
        id="honey_bread",
        name="Honey Bread",
        description="Warm bread drizzled with wildflower honey.",
        item_type=ItemType.FOOD,
        effects={"hunger": 45, "energy": 10},
        mood_bonus=10,
        duck_reaction="ecstatic",
        use_message="*CHOMP* Sweet AND bread?! This is the best day of my life!",
        rarity="uncommon",
        icon="[H]",
    ),

    # ── Crafted decorations & keepsakes ────────────────────────────
    "crystal_lamp": Item(
        id="crystal_lamp",
        name="Crystal Lamp",
        description="A softly glowing lamp carved from pond crystal.",
        item_type=ItemType.DECORATION,
        effects={"fun": 10},
        mood_bonus=8,
        duck_reaction="amazed",
        use_message="*stares into the glow* Ooooh... sparkly...",
        consumable=False,
        rarity="rare",
        icon="[i]",
    ),
    "flower_wreath": Item(
        id="flower_wreath",
        name="Flower Wreath",
        description="A woven ring of fresh meadow flowers.",
        item_type=ItemType.DECORATION,
        effects={"fun": 10, "social": 5},
        mood_bonus=7,
        duck_reaction="happy",
        use_message="*wears it like a crown* I am the Flower Monarch!",
        consumable=False,
        icon="[@]",
    ),
    "moss_carpet": Item(
        id="moss_carpet",
        name="Moss Carpet",
        description="A plush carpet of living moss. Soft on webbed feet.",
        item_type=ItemType.DECORATION,
        effects={"energy": 5},
        mood_bonus=5,
        duck_reaction="cozy",
        use_message="*pat pat pat* So soft! Like walking on clouds!",
        consumable=False,
        icon="[m]",
    ),
    "pebble_path": Item(
        id="pebble_path",
        name="Pebble Path",
        description="A neat little walkway of smooth pebbles.",
        item_type=ItemType.DECORATION,
        effects={"fun": 5},
        mood_bonus=4,
        duck_reaction="proud",
        use_message="*waddles along the path* Very dignified. Very fancy.",
        consumable=False,
        icon="[:]",
    ),
    "shell_mobile": Item(
        id="shell_mobile",
        name="Shell Mobile",
        description="Spiraling shells that chime in the breeze.",
        item_type=ItemType.DECORATION,
        effects={"fun": 8},
        mood_bonus=6,
        duck_reaction="mesmerized",
        use_message="*watches it spin* Tink tink tink... hypnotic...",
        consumable=False,
        rarity="uncommon",
        icon="[s]",
    ),
    "storage_basket": Item(
        id="storage_basket",
        name="Storage Basket",
        description="A sturdy woven basket for stashing treasures.",
        item_type=ItemType.DECORATION,
        effects={},
        mood_bonus=4,
        duck_reaction="satisfied",
        use_message="*tucks treasures inside* Organized! Mostly.",
        consumable=False,
        icon="[u]",
    ),
    "torch": Item(
        id="torch",
        name="Garden Torch",
        description="A flickering torch to keep the night cozy.",
        item_type=ItemType.DECORATION,
        effects={"fun": 5},
        mood_bonus=5,
        duck_reaction="warm",
        use_message="*warms feathers by the flame* Toasty!",
        consumable=False,
        icon="[!]",
    ),
    "water_bowl": Item(
        id="water_bowl",
        name="Water Bowl",
        description="A clean stone bowl of fresh water.",
        item_type=ItemType.DECORATION,
        effects={"cleanliness": 10},
        mood_bonus=5,
        duck_reaction="refreshed",
        use_message="*splish splash* A private pond! Luxury!",
        consumable=False,
        icon="[o]",
    ),
    "lucky_charm": Item(
        id="lucky_charm",
        name="Lucky Charm",
        description="A four-leaf clover encased in crystal.",
        item_type=ItemType.SPECIAL,
        effects={},
        mood_bonus=15,
        duck_reaction="amazed",
        use_message="*holds it up to the light* I can FEEL the luck!",
        consumable=False,
        rarity="rare",
        icon="[4]",
    ),
    "magic_wand": Item(
        id="magic_wand",
        name="Magic Wand",
        description="A twisted twig humming with mysterious energy.",
        item_type=ItemType.SPECIAL,
        effects={"fun": 15},
        mood_bonus=12,
        duck_reaction="dramatic",
        use_message="*waves wand* ALAKAZAM! ...did anything happen? It felt magical.",
        consumable=False,
        rarity="rare",
        icon="[/]",
    ),
    ...
    "shiny_object": Item(
        id="shiny_object",
        name="Shiny Object",
        description="Something glittery — exactly what a magpie would want.",
        item_type=ItemType.SPECIAL,
        effects={},
        mood_bonus=5,
        duck_reaction="curious",
        use_message="*tilts head* Shiny... the magpie will love this.",
        consumable=False,
        rarity="uncommon",
        icon="[*]",
    ),
    "water_token": Item(
        id="water_token",
        name="Water Token",
        description="An ancient token pulled from the deepest waters.",
        item_type=ItemType.SPECIAL,
        effects={},
        mood_bonus=10,
        duck_reaction="awed",
        use_message="*the token ripples like liquid* One of three...",
        consumable=False,
        rarity="rare",
        icon="[W]",
    ),
    "earth_token": Item(
        id="earth_token",
        name="Earth Token",
        description="An ancient token unearthed from deep soil.",
        item_type=ItemType.SPECIAL,
        effects={},
        mood_bonus=10,
        duck_reaction="awed",
        use_message="*the token rumbles softly* One of three...",
        consumable=False,
        rarity="rare",
        icon="[E]",
    ),
    "sky_token": Item(
        id="sky_token",
        name="Sky Token",
        description="An ancient token that fell from a stormy sky.",
        item_type=ItemType.SPECIAL,
        effects={},
        mood_bonus=10,
        duck_reaction="awed",
        use_message="*the token hums like distant thunder* One of three...",
        consumable=False,
        rarity="rare",
        icon="[K]",
    ),
    ...
    "ancient_amulet": Item(
        id="ancient_amulet",
        name="Ancient Amulet",
        description="A weathered amulet gifted by the mysterious stranger.",
        item_type=ItemType.SPECIAL,
        effects={},
        mood_bonus=20,
        duck_reaction="reverent",
        use_message="*wears the amulet solemnly* I am a duck of destiny.",
        consumable=False,
        rarity="legendary",
        icon="[A]",
    ),
    "guardian_blessing": Item(
        id="guardian_blessing",
        name="Guardian's Blessing",
        description="A warm, lingering blessing from the land's guardian.",
        item_type=ItemType.SPECIAL,
        effects={},
        mood_bonus=25,
        duck_reaction="serene",
        use_message="*feathers shimmer faintly* The pond watches over me.",
        consumable=False,
        rarity="legendary",
        icon="[G]",
    ),
