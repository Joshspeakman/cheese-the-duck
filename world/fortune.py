...
FORTUNE_MESSAGES = {
    FortuneCategory.GENERAL: {
        FortuneRarity.COMMON: [
            ...
            "Stand still long enough and something will happen. Probably.",
            "Your waddle has a certain grace today. Don't question it.",
            "A puddle appears in your future. It is a good puddle.",
            "The universe owes you a snack. Collection date: uncertain.",
            "Today is a day. You are a duck. These are the facts.",
            "Something mildly interesting approaches. Brace yourself.",
            "Your greatest strength is standing here. Own it.",
        ],
        FortuneRarity.UNCOMMON: [
            ...
            "An unexpected crumb changes everything. Stay alert.",
            "Something you lost will return. It is not bread though. Sorry.",
            "A decision approaches. Both options lead to standing somewhere.",
            "The wind carries a message for you. It says 'whoosh.' Interpret freely.",
            "Your feathers align with the cosmos. Whatever that means.",
            "Someone will think of you today. They will also think of bread. Unrelated.",
        ],
        FortuneRarity.RARE: [
            ...
            "A great bread is coming. You are not ready. No one is ready.",
            "Destiny has your name on a list. It is misspelled, but it counts.",
            "The pond of opportunity ripples in your direction. Wade carefully.",
        ],
        FortuneRarity.LEGENDARY: [
            ...
            "You will find THE bread. The one the prophecy spoke of.",
            "The universe has decided. You are important. Act accordingly.",
        ],
    },
    FortuneCategory.LOVE: {
        FortuneRarity.COMMON: [
            ...
            "Someone somewhere is thinking about you. It might be you.",
            "Affection arrives at its own pace. Yours is a waddle.",
            "Your human's love is unconditional. Your love for bread is also unconditional.",
            "A warm feeling approaches. It is either love or the sun. Unclear.",
            "You are appreciated more than you know. Mostly by the bread industry.",
        ],
        FortuneRarity.UNCOMMON: [
    ...
    FortuneCategory.LUCK: {
        FortuneRarity.COMMON: [
            ...
            "Luck smiles upon you. It is a weird smile, but still.",
            "A lucky crumb lands within waddling distance.",
            "Fortune is a wheel. You are the duck standing next to it.",
            "Something good approaches. Not fast. But it approaches.",
        ],
        FortuneRarity.UNCOMMON: [
    ...
    FortuneCategory.ADVENTURE: {
        FortuneRarity.COMMON: [
            ...
            "A short waddle reveals something new. Emphasis on short.",
            "The unknown calls. You may decline the call.",
            "An uncharted corner of the pond beckons gently.",
            "Explore. Or don't. The adventure is optional.",
        ],
        FortuneRarity.UNCOMMON: [
    ...
    FortuneCategory.WEALTH: {
        FortuneRarity.COMMON: [
            ...
            "A crumb of great value appears in your path.",
            "Your bread portfolio diversifies. Sourdough incoming.",
            "Modest treasure finds its way to modest ducks. You qualify.",
            "Your net worth increases by one shiny thing.",
        ],
        FortuneRarity.UNCOMMON: [
    ...
    FortuneCategory.FRIENDSHIP: {
        FortuneRarity.COMMON: [
            ...
            "A friend appreciates your silence. And your quacking. Both.",
            "Someone nearby thinks you are alright. High praise.",
            "Shared bread is halved. Shared friendship is doubled. The math works.",
            "A companion awaits. Patience. They waddle at their own speed.",
        ],
        FortuneRarity.UNCOMMON: [
    ...
    FortuneCategory.HEALTH: {
        FortuneRarity.COMMON: [
            ...
            "Your feathers are in excellent condition. Preen on.",
            "Hydration is key. You live near water. This should be easy.",
            "A good stretch prevents a stiff waddle. Stretch now.",
        ],
        FortuneRarity.UNCOMMON: [
    ...
    FortuneCategory.WISDOM: {
        FortuneRarity.COMMON: [
            ...
            "The wise duck knows when to quack and when to stand quietly.",
            "Not all who waddle are lost. You are. But not all.",
            "Silence teaches more than quacking. You will ignore this.",
        ],
        FortuneRarity.UNCOMMON: [
