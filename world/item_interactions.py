...
# Life stage groups for animation selection
YOUNG_STAGES = {"egg", "hatchling", "duckling", "juvenile"}
MATURE_STAGES = {"young_adult", "adult", "mature", "elder"}
LEGENDARY_STAGES = {"legendary"}


def get_stage_group(growth_stage: str) -> str:
    """Get animation group for a growth stage."""
    stage_lower = growth_stage.lower() if growth_stage else "adult"
    if stage_lower in YOUNG_STAGES:
        return "young"
    elif stage_lower in LEGENDARY_STAGES:
        return "legendary"
    else:
        return "mature"
...
INTERACTION_ANIMATIONS = {
    # Ball - "The Chase" - duck kicks ball, chases, catches with joy
    # Animations organized by life stage group
    "toy_ball": {
        # YOUNG (hatchling, duckling, juvenile) - small 4-char sprite
        "play_young": [
            # Frame 1: Duckling spots ball
            [
                "  O      ",
                "  __ (o>)",
                "     /'/) ",
        ...
        # MATURE (adult, mature, elder) - medium 6-char sprite
        "play_mature": [
            # Frame 1: Adult duck approaches
            [
                " O        ",
                "  ___     ",
                " (o__)>   ",
        ...
        # LEGENDARY - special 7-char sprite with crown
        "play_legendary": [
            # Frame 1: Legendary duck considers ball
            [
                "*~___~*   ",
                "(^_^)> O  ",
                "/'=='\\_   ",
            ],
            # Frame 2: Majestic kick
            [
                "*~___~*   ",
                "(^_^)>  O ",
                "/'=='\\ == ",
            ...
            # Frame 4: Legendary pursuit
            [
                "  *~___~* ",
                "  (^o^)> O",
                "  /'=='\\ !",
            ],
            # Frame 5: Victorious catch
            [
                "   *~O~*  ",
                "   (^v^)> ",
                "   /'=='\\ ",
        ...
        # Fallback for old code (will be deprecated)
        "play": [
            [
                "  O      ",
                "  __ (o>)",
    ...
    # Blocks - "Tower Builder" - duck stacks blocks into tower
    "toy_blocks": {
        # YOUNG (hatchling, duckling, juvenile)
        "play_young": [
            # Frame 1: Duckling spots blocks
            [
                " □□       ",
                "  __ (o>) ",
                "     /'/) ",
            ],
            # Frame 2: Picks up block
            [
                " □        ",
                " (o>)□    ",
                " /'/)     ",
        ...
        # MATURE (adult, mature, elder)
        "play_mature": [
            # Frame 1: Adult surveys blocks
            [
                " □□□       ",
                "  ___      ",
                " (o__)>    ",
            ...
            # Frame 2: Building begins
            [
                " □□        ",
                " (o__)>□   ",
                " /'__\\     ",
            ],
            # Frame 3: Tower taking shape
            [
                "  □        ",
                " □□        ",
                "  (o__)>   ",
        ...
        # LEGENDARY
        "play_legendary": [
            # Frame 1: Legendary architect
            [
                "*~___~*    ",
                "(^_^)> □□□ ",
                "/'=='\\_    ",
            ],
            # Frame 2: Speed building
            [
                "*~___~* □  ",
                "(^_^)>□□   ",
                "/'=='\\_    ",
            ],
            # Frame 3: Castle forming
            [
                "   ⌂      ",
                "*~___~*□□ ",
                "(^_^)>     ",
    ...
    "toy_sandbox": {
        ...
        # LEGENDARY - builds epic fortress
        "play_legendary": [
            [
                " [       ]  ",
                " |  . .  |  ",
    ...
    # Trumpet - Jazz Solo style
    "toy_trumpet": {
        # YOUNG - learning to toot
        "music_young": [
            [
                "  <)       ",
                "  (o>)     ",
...
def execute_interaction(item_id: str, duck_state: Dict = None) -> Optional[InteractionResult]:
    ...
    # Get animation frames with life-stage support
    ...
    # Try stage-specific animation first, fall back to generic
    growth_stage = duck_state.get("growth_stage", "adult")
    stage_group = get_stage_group(growth_stage)
    stage_animation_key = f"{animation_key}_{stage_group}"
    
    # Priority: stage-specific > generic
    animation_frames = animation_data.get(stage_animation_key, [])
    if not animation_frames:
        animation_frames = animation_data.get(animation_key, [])
    
    # Default animation if none defined (stage-appropriate)
    if not animation_frames:
        if stage_group == "young":
            animation_frames = [
                ["  __ ", "(o>)", "/'/)"],
                ["  __ ", "(^>)", "/'/)"],
            ]
        elif stage_group == "legendary":
            animation_frames = [
                ["*~___~*", "(^_^)>", "/'=='\\_"],
                ["*~___~*", "(^v^)>", "/'=='\\_"],
            ]
