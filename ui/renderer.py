...
class Renderer:
    ...
    def _overlay_help(self, base_output: List[str], width: int) -> List[str]:
        ...
        help_text = [
            ...
            "[D]/[4] Pet     [Z]/[5] Sleep",
            "[U] Use Item    [I] Inventory",
            "",
            "=== ITEMS & SHOP ===",
            "[B] Shop        [<] Trading   [C] Craft",
            "[R] Build       [V] Decorate",
            "",
            "=== WORLD ===",
            "[E] Explore     [A] Areas     [9] Garden",
            "[W] Weather     [6] Treasure",
            "",
            "=== ACTIVITIES ===",
            "[J] Minigames   [7] Tricks    [0] Festivals",
            "[;] Photo       [=] Diary",
            "",
            "=== MY DUCK ===",
            "[T] Talk        [S] Stats     [G] Goals",
            "[Y] Scrapbook   [!] Titles    [K] Duck Fact",
            "",
            "=== COLLECTIONS ===",
            "['] Collectibles  [8] Prestige  [\\] Secrets",
            "",
            "=== SETTINGS ===",
