    ...
    def _load_category_items(self):
        ...
        if self._current_category == SettingsCategory.AUDIO:
            self._items = [
                ...
                SettingItem("radio_volume", "Radio Volume", "audio", "slider",
                           settings.audio.radio_volume, min_value=0, max_value=1, step=0.1,
                           description="Streaming radio volume"),
                ...
                SettingItem("radio_enabled", "Radio", "audio", "toggle",
                           settings.audio.radio_enabled,
                           description="Enable/disable streaming radio"),
